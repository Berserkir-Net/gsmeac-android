...
import net.berserkir.apps.gsmeac.GSMEACApplication;
import net.berserkir.apps.gsmeac.R;
import net.berserkir.apps.gsmeac.adapter.BriefsAdapter;
import net.berserkir.apps.gsmeac.database.helper.BriefHelper;
import net.berserkir.apps.gsmeac.database.model.Brief;
import net.berserkir.apps.gsmeac.util.comparator.MostRecentlyUpdatedBriefComparator;
